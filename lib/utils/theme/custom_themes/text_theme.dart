...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineSmall: TextStyle().copyWith(fontSize: 24, fontWeight: FontWeight.w600, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headlineSmall: TextStyle().copyWith(fontSize: 24, fontWeight: FontWeight.w600, color: Colors.white),
